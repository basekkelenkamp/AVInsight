...
static PyObject *impl_itsdangerous$serializer$$$function__13__loads_unsafe_impl(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Tried code:
    {
        ...
        tmp_return_value = MAKE_TUPLE_EMPTY(2);
        {
            ...
            {
                PyObject *dir_call_args[] = {tmp_dircall_arg1_1, tmp_dircall_arg2_1, tmp_dircall_arg3_1, tmp_dircall_arg4_1};
                tmp_tuple_element_1 = impl___main__$$$function__9_complex_call_helper_pos_keywords_star_dict(dir_call_args);
            }
            if (tmp_tuple_element_1 == NULL) {
                assert(ERROR_OCCURRED());
    ...
    // Tried code:
    {
        ...
        tmp_return_value = MAKE_TUPLE_EMPTY(2);
        {
...

            {
                ...
                tmp_tuple_element_3 = impl___main__$$$function__2_complex_call_helper_pos_star_dict(dir_call_args);
            }
